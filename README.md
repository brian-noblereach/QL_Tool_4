...
**v04.2 — Unified Synthesis (current).** Two of the six dimensions are now driven by a synthesis layer that fuses the Competitive flow output, the Literature Review output, and the company's Solution Value data into one cohesive presentation. The rubric is unchanged — these are evidence panels, not new scoring inputs:
